...
/**
 * Factory function to create a Codelex transformer for twoslash integrations.
 */
export function transformerTwoslash(options: TransformerTwoslashIndexOptions = {}): CodelexTransformer {
