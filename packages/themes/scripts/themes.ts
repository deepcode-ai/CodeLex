...
`,
      ...
      await fs.writeFile(
        `./dist/${t.name}.d.mts`,
        `import type { ThemeRegistration } from '@codelexjs/core'
...
`,
      ...
      return {
        ...
        type: theme.type,
        import: `__(() => import('@codelexjs/themes/${t.name}')) as unknown as DynamicImportThemeRegistration__`,
      }
    }))
