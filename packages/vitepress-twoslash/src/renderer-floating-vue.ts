import type { RendererRichOptions, TwoslashRenderer } from '@codelexjs/twoslash'
import type { Element, ElementContent, Text } from 'hast'
import type { CodelexTransformerContextCommon } from 'codelex'
import { defaultHoverInfoProcessor, rendererRich } from '@codelexjs/twoslash'
...
export function rendererFloatingVue(options: TwoslashFloatingVueRendererOptions = {}): TwoslashRenderer {
  ...
  const hoverBasicProps = {
    ...
    'popper-class': ['codelex', classFloatingPanel, classCopyIgnore, classCode].join(' '),
      ...
      completionCompose({ popup, cursor }) {
        return [
          <Element>{
            ...
            tagName: 'v-menu',
            properties: {
              'popper-class': ['codelex twoslash-completion', classCopyIgnore, classFloatingPanel],
...
function renderMarkdown(this: CodelexTransformerContextCommon, md: string): ElementContent[] {
...
function renderMarkdownInline(this: CodelexTransformerContextCommon, md: string, context?: string): ElementContent[] {
