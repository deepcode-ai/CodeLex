import angularHtml from '@codelex/langs/angular-html'
import angularTs from '@codelex/langs/angular-ts'
import html from '@codelex/langs/html'
import ts from '@codelex/langs/typescript'
import vue from '@codelex/langs/vue'
import vl from '@codelex/themes/vitesse-light'
