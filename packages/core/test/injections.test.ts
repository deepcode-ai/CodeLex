import angularHtml from '@codelexjs/langs/angular-html'
import angularTs from '@codelexjs/langs/angular-ts'
import html from '@codelexjs/langs/html'
import ts from '@codelexjs/langs/typescript'
import vue from '@codelexjs/langs/vue'
import vl from '@codelexjs/themes/vitesse-light'
import { codeToHtml, createHighlighterCore, createJavaScriptRegexEngine } from 'codelex'
