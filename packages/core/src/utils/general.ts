...
/**
 * Check if the language is plaintext that is ignored by Codelex.
 *
...
/**
 * Check if the language is specially handled or bypassed by Codelex.
 *
...
/**
 * Check if the theme is specially handled or bypassed by Codelex.
 *
