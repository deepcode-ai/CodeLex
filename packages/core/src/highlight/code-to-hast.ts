...
export function codeToHast(
  ...
  transformerContext: CodelexTransformerContextCommon = {
    meta: {},
    options,
...
export function tokensToHast(
  ...
  transformerContext: CodelexTransformerContextSource,
  ...
  let preNode: Element = {
    ...
    tagName: 'pre',
    properties: {
      class: `codelex ${options.themeName || ''}`,
  ...
  const context: CodelexTransformerContext = {
    ...transformerContext,
    structure,
    addClassToHast,
    get source() {
