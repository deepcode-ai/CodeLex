import type { ThemeRegistrationAny, ThemeRegistrationResolved } from '@codelexjs/types'
...
const RESOLVED_KEY = '__codelex_resolved'

/**
 * Normalize a textmate theme to codelex theme
 */
