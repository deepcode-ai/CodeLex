...
import { createHighlighter } from '../../codelex/src/index'
...
describe('should', () => {
  ...
  it('dynamic load theme and lang', async () => {
    ...
    await codelex.loadLanguage('css')
