import type { HighlighterGeneric } from '@codelexjs/types'
import type {} from 'hast'
import type { BundledLanguage } from './langs-bundle-full'
import type { BundledTheme } from './themes'
import { createdBundledHighlighter, createSingletonShorthands, guessEmbeddedLanguages } from '@codelexjs/core'
 ...
 * @see https://codelex.style/guide/bundles#codelex-bundle-full
 *
 * For granular control over the bundle, check:
 * @see https://codelex.style/guide/bundles#fine-grained-bundle
 */
