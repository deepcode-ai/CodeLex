...
it('flat colorReplacements', async () => {
  ...
  expect(result.replace(/>/g, '>\n'))
    .toMatchInlineSnapshot(`
      "<pre class="codelex codelex-themes vitesse-light material-theme-palenight" style="background-color:#ffffff;--codelex-dark-bg:#292D3E;color:var(---replaced-1);--codelex-dark:#babed8" tabindex="0">
      <code>
      <span class="line">
      <span style="color:var(---replaced-2);--codelex-dark:#BABED8">
      console</span>
      <span style="color:#999999;--codelex-dark:#89DDFF">
      .</span>
      <span style="color:#59873A;--codelex-dark:#82AAFF">
      log</span>
      <span style="color:#999999;--codelex-dark:#BABED8">
      (</span>
      <span style="color:#B5695977;--codelex-dark:#89DDFF">
      "</span>
      <span style="color:#B56959;--codelex-dark:#C3E88D">
      hi</span>
      <span style="color:#B5695977;--codelex-dark:#89DDFF">
      "</span>
      <span style="color:#999999;--codelex-dark:#BABED8">
...
it('scoped colorReplacements', async () => {
  ...
  expect(result.replace(/>/g, '>\n'))
    .toMatchInlineSnapshot(`
      "<pre class="codelex codelex-themes custom-light custom-dark" style="background-color:var(---replaced-3);--codelex-dark-bg:var(---replaced-1);color:var(---replaced-4);--codelex-dark:var(---replaced-4)" tabindex="0">
      <code>
      <span class="line">
      <span style="color:var(---replaced-4);--codelex-dark:var(---replaced-4)">
      console.log(</span>
      <span style="color:#A3BE8C;--codelex-dark:#A3BE8C">
      "hi"</span>
      <span style="color:var(---replaced-4);--codelex-dark:var(---replaced-4)">
      )</span>
      </span>
