...
export interface CodelexTransformerStyleToClass extends CodelexTransformer {
 ...
 */
export function transformerStyleToClass(options: TransformerStyleToClassOptions = {}): CodelexTransformerStyleToClass {
  const {
