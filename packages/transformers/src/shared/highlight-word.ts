...
import type { CodelexTransformerContext } from 'codelex/core'

export function highlightWordInLine(this: CodelexTransformerContext, line: Element, ignoredElement: Element | null, word: string, className: string): void {
