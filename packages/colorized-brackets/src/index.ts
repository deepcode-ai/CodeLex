 ...
 *
 * @param options
 * @param options.themes - custom themes; all Codelex built-in themes are supported without additional configuration
...
export function transformerColorizedBrackets(
  ...
  const transformer: CodelexTransformer = {
