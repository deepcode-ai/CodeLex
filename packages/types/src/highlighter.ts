...
/**
 * Internal context of Codelex, core textmate logic
 */
export interface CodelexInternal<BundledLangKeys extends string = never, BundledThemeKeys extends string = never> {
  /**
...
export interface HighlighterGeneric<BundledLangKeys extends string, BundledThemeKeys extends string>
   ...
   * @deprecated
   */
  getInternalContext: () => CodelexInternal
  /**
...
/**
 * The fine-grained core Codelex highlighter instance.
 */
