...
export interface CodeOptionsMultipleThemes<Themes extends string = string> {
   ...
   *
   * ```html
   * <span style="color:#111;--codelex-dark:#fff;">code</span>
   * ```
   *
   * @see https://github.com/deepcode-ai/codelex#lightdark-dual-themes
   */
   ...
   *
   * ```html
   * <span style="color:#{light};--codelex-dark:#{dark};--codelex-custom:#{custom};">code</span>
   * ```
   *
   * When set to `false`, no default styles will be applied, and totally up to users to apply the styles:
   *
   * ```html
   * <span style="--codelex-light:#{light};--codelex-dark:#{dark};--codelex-custom:#{custom};">code</span>
   * ```
   *
   *
   * @default 'light'
...
export interface CodeOptionsMeta {
  /**
   * Meta data passed to Codelex, usually used by plugin integrations to pass the code block header.
   *
