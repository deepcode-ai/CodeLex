...
export interface ThemeRegistrationResolved extends RawTheme {
   ...
   *
   * Will be used by codelex on `lang: 'ansi'` to find ANSI colors, and to find the default foreground/background colors.
   */
