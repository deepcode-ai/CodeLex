...
export interface RehypeCodelexExtraOptions {
  /**
   ...
   *
   * @see https://codelex.style/packages/rehype#inline-code
   * @default false
   */
...
export type RehypeCodelexCoreOptions =
  & CodeOptionsThemes<BuiltinTheme>
  & TransformerOptions
  & CodeOptionsMeta
  & RehypeCodelexExtraOptions
