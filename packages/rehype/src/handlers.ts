...
export type RehypeCodelexHandler = (
  tree: Root,
  node: Element
) => {
  type: 'inline' | 'pre'
...
export const InlineCodeHandlers: Record<Truthy<RehypeCodelexCoreOptions['inline']>, RehypeCodelexHandler> = {
...
export const PreHandler: RehypeCodelexHandler = (_tree, node) => {
