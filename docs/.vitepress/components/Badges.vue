...
<template>
  <p flex="~ gap-2" h-5>
    ...
    <a :href="`https://github.com/deepcode-ai/codelex/tree/main/packages/${name.replace('@codelex/', '')}`" target="_blank"><img src="https://img.shields.io/badge/source-a?logo=github&color=1B3C4A" alt="GitHub"></a>
  </p>
</template>
